export default function Search() {
  return (
    <div className="w-1/4 flex flex-col items-center">
      <button className=" w-1/2 rounded-lg h-10 mt-5 border-2 border-blue-900 hover:bg-blue-400">
        Leave Feedback
      </button>
      <div className="mt-20 w-4/5 h-4/5 border-2 border-blue-900 rounded-lg  pt-5">
